...
::: tip Generated on 2026-04-24 06:16:28, from kubo 0.41.0
This document was autogenerated from CLI help text in [kubo 0.41.0](https://github.com/ipfs/kubo/releases/tag/v0.41.0)
...
SYNOPSIS
  ipfs dag import [--pin-roots=false] [--silent] [--stats] [--fast-provide-root]
                  [--fast-provide-dag] [--fast-provide-wait] [--allow-big-block]
                  [--] <path>...
...
DEPRECATED SUBCOMMANDS
  ipfs routing reprovide - Trigger reprovider (legacy provider only).
