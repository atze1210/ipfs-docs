...
::: tip Generated on 2026-03-02, from kubo v0.40.1
...
**Content-Type:** application/x-tar, or application/gzip when compress=true
...
Request body should be `multipart/form-data` with the IPNS record bytes.
